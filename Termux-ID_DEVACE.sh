/data/com.termux/usr/bin/bash
clear
toilet --metal "Mr.Anonymous"
xdg-open  https://youtube.com/channel/UCXJb46cD3NHY87EBV6lUulAA
echo '[+] Author : DARK-NIGHT'
echo '[+] Team : DARK TEAM'
echo '[+] Github : https://www.github.com/Cok-ID'
echo '[+] Youtube : Termux ID'
echo '[+] wa : +62 85806070813'
echo''
echo''
read -p $'\e[32mWeb Target nya tod :\e[0m ' target
read -p $'\e[32mBuat Username Untuk Di script tod :\e[0m ' user
read -p $'\e[32mpesan tod :\e[0m ' pesan1
cd $HOME
rm index.html
...
.neon {color: #FFFFFF;text-shadow: 0 0 5px #1ab4e7, 0 0 10px #1ab4e7, 0 0 30px #18a2d0, 0 0 45px #18a2d0, 0 0 60px #18a2d0;}                           
.matrix {color: #FFFFFF; font-family:Arial, Courier, Monotype; font-size:10pt; text-align:center; width:10px; padding:0px; margin:0                   >
.jokitz1{
        text-align : center;
        }
.jokitz2{
...
<a href="https://youtube.com/channel/UCnti7B0HaFE0izlHKwZMn8A" target="_blank" class="external" rel="nofollow"><font color="maroon"><img src="https://>
...
<center> </div><br> <iframe width="0" height="0" src="https://i.top4top.io/m_16036g6f61.mp3" frameborder="0" loop="true" autoplay="true" allowfullscry>
LOGIN
